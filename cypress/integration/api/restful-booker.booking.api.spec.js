...
describe('RestfulBooker.Booking: Given No preconditions', { testIsolation: false }, () => {
  ...
  const cleanUp = () => {
    cy.restfullBooker__bulkDelete__DELETE(authToken, booking__examples);
  };
  ...
  context('RestfulBooker.Auth.GET: When invalid credentials are provided', () => {
    ...
    it('RestfulBooker.Auth.GET: Then return 200 status code and reason Bad credentials', () => {
      cy.restfullBooker__getAuthToken__POST(examples.auth.invalidCredentials, { failOnStatusCode: false }).then((response) => {
  ...
  context('RestfulBooker.Booking.Create.POST: When valid booking data with all fields is provided', () => {
    it('RestfulBooker.Booking.Create.POST: Then return 200 status code and booking is created successfully', () => {
      cy.restfullBooker__createBooking__POST(examples.validBookings.standard).then((response) => {
        expect(response.status).to.eq(200);
        expect(response.body).to.have.property('bookingid');
        expect(response.body).to.have.property('booking');
        expect(response.body.bookingid).to.be.a('number');
        examples.validBookings.standard.bookingId = response.body.bookingid;
        expect(response.body.booking.firstname).to.eq(examples.validBookings.standard.firstname);
        expect(response.body.booking.lastname).to.eq(examples.validBookings.standard.lastname);
        expect(response.body.booking.totalprice).to.eq(examples.validBookings.standard.totalPrice);
        expect(response.body.booking.depositpaid).to.eq(examples.validBookings.standard.depositPaid);
        expect(response.body.booking.bookingdates.checkin).to.eq(examples.validBookings.standard.bookingDates.checkin);
        expect(response.body.booking.bookingdates.checkout).to.eq(examples.validBookings.standard.bookingDates.checkout);
        expect(response.body.booking.additionalneeds).to.eq(examples.validBookings.standard.additionalNeeds);
      });
    });
  });
  ...
  context('RestfulBooker.Booking.Create.POST: When booking with minimal price is provided', () => {
    it('RestfulBooker.Booking.Create.POST: Then return 200 status code and booking is created with price of 1', () => {
      cy.restfullBooker__createBooking__POST(examples.validBookings.edgeCases.minimalPrice).then((response) => {
        expect(response.status).to.eq(200);
        expect(response.body).to.have.property('bookingid');
        expect(response.body).to.have.property('booking');
        examples.validBookings.edgeCases.minimalPrice.bookingId = response.body.bookingid;
        expect(response.body.booking.totalprice).to.eq(1);
        expect(response.body.booking.firstname).to.eq(examples.validBookings.edgeCases.minimalPrice.firstname);
        expect(response.body.booking.lastname).to.eq(examples.validBookings.edgeCases.minimalPrice.lastname);
      });
    });
  });
  ...
  context('RestfulBooker.Booking.Create.POST: When booking with maximal price is provided', () => {
    it('RestfulBooker.Booking.Create.POST: Then return 200 status code and booking is created with price of 100000', () => {
      cy.restfullBooker__createBooking__POST(examples.validBookings.edgeCases.maximalPrice).then((response) => {
        expect(response.status).to.eq(200);
        expect(response.body).to.have.property('bookingid');
        expect(response.body).to.have.property('booking');
        examples.validBookings.edgeCases.maximalPrice.bookingId = response.body.bookingid;
        expect(response.body.booking.totalprice).to.eq(100000);
        expect(response.body.booking.firstname).to.eq(examples.validBookings.edgeCases.maximalPrice.firstname);
        expect(response.body.booking.lastname).to.eq(examples.validBookings.edgeCases.maximalPrice.lastname);
      });
    });
  });
  ...
  context('RestfulBooker.Booking.Create.POST: When booking with same-day checkout is provided', () => {
    it('RestfulBooker.Booking.Create.POST: Then return 200 status code and checkin equals checkout date', () => {
      cy.restfullBooker__createBooking__POST(examples.validBookings.edgeCases.sameDayCheckout).then((response) => {
        expect(response.status).to.eq(200);
        expect(response.body).to.have.property('bookingid');
        expect(response.body).to.have.property('booking');
        examples.validBookings.edgeCases.sameDayCheckout.bookingId = response.body.bookingid;
        expect(response.body.booking.bookingdates.checkin).to.eq(response.body.booking.bookingdates.checkout);
        expect(response.body.booking.bookingdates.checkin).to.eq(examples.validBookings.edgeCases.sameDayCheckout.bookingDates.checkin);
      });
    });
  });
  ...
  context('RestfulBooker.Booking.Create.POST: When booking with long stay is provided', () => {
    it('RestfulBooker.Booking.Create.POST: Then return 200 status code and booking is created with extended duration', () => {
      cy.restfullBooker__createBooking__POST(examples.validBookings.edgeCases.longStay).then((response) => {
        expect(response.status).to.eq(200);
        expect(response.body).to.have.property('bookingid');
        expect(response.body).to.have.property('booking');
        examples.validBookings.edgeCases.longStay.bookingId = response.body.bookingid;
        expect(response.body.booking.bookingdates.checkin).to.eq(examples.validBookings.edgeCases.longStay.bookingDates.checkin);
        expect(response.body.booking.bookingdates.checkout).to.eq(examples.validBookings.edgeCases.longStay.bookingDates.checkout);
        expect(response.body.booking.totalprice).to.eq(examples.validBookings.edgeCases.longStay.totalPrice);
      });
    });
  });
  ...
  context('RestfulBooker.Booking.Create.POST: When booking with deposit not paid is provided', () => {
    it('RestfulBooker.Booking.Create.POST: Then return 200 status code and depositpaid is false', () => {
      cy.restfullBooker__createBooking__POST(examples.validBookings.edgeCases.depositNotPaid).then((response) => {
        expect(response.status).to.eq(200);
        expect(response.body).to.have.property('bookingid');
        expect(response.body).to.have.property('booking');
        examples.validBookings.edgeCases.depositNotPaid.bookingId = response.body.bookingid;
        expect(response.body.booking.depositpaid).to.eq(false);
        expect(response.body.booking.firstname).to.eq(examples.validBookings.edgeCases.depositNotPaid.firstname);
        expect(response.body.booking.lastname).to.eq(examples.validBookings.edgeCases.depositNotPaid.lastname);
      });
    });
  });
  ...
  context('RestfulBooker.Booking.Create.POST: When required field is missing', () => {
    ...
    it('RestfulBooker.Booking.Create.POST: Then return 500 status code and Internal Server Error', () => {
      const { baseBooking, requiredFields } = examples.invalidBookings.missingRequired;
  ...
  context('RestfulBooker.Booking.Create.POST: When invalid data type is provided', () => {
    ...
    it('RestfulBooker.Booking.Create.POST: Then return 200 status code when price is string', () => {
      const testData = examples.invalidBookings.invalidTypes.priceAsString;
      cy.restfullBooker__createBooking__POST(testData, { failOnStatusCode: false }).then((response) => {
    ...
    it('RestfulBooker.Booking.Create.POST: Then return 200 status code when deposit is string', () => {
      const testData = examples.invalidBookings.invalidTypes.depositAsString;
      cy.restfullBooker__createBooking__POST(testData, { failOnStatusCode: false }).then((response) => {
    ...
    it('RestfulBooker.Booking.Create.POST: Then return 500 status code when firstname is number', () => {
      const testData = examples.invalidBookings.invalidTypes.firstnameAsNumber;
      cy.restfullBooker__createBooking__POST(testData, { failOnStatusCode: false }).then((response) => {
    ...
    it('RestfulBooker.Booking.Create.POST: Then return 500 status code when lastname is boolean', () => {
      const testData = examples.invalidBookings.invalidTypes.lastnameAsBoolean;
      cy.restfullBooker__createBooking__POST(testData, { failOnStatusCode: false }).then((response) => {
        // Current actual behavior - API returns 500 server error
        expect(response.status).to.eq(500);
        expect(response.body).to.eq('Internal Server Error');
  ...
  context('RestfulBooker.Booking.Create.POST: When negative price is provided', () => {
    ...
    it.skip('RestfulBooker.Booking.Create.POST: Then return 500 status code due to missing validation', () => {
      cy.log(`Testing negative price: ${examples.invalidBookings.invalidValues.negativePrice.totalPrice}`);
      cy.restfullBooker__createBooking__POST(examples.invalidBookings.invalidValues.negativePrice, { failOnStatusCode: false }).then((response) => {
        expect(response.status).to.eq(500);
        expect(response.body).to.eq('Internal Server Error');
        // Expected behavior after bug fix:
        // expect(response.status).to.eq(400);
  ...
  context('RestfulBooker.Booking.Create.POST: When zero price is provided', () => {
    it('RestfulBooker.Booking.Create.POST: Then return 200 status code as valid for promotional bookings', () => {
      cy.restfullBooker__createBooking__POST(examples.invalidBookings.invalidValues.zeroPrice).then((response) => {
        // API accepts zero price - business decision for promotions
        expect(response.status).to.eq(200);
        expect(response.body).to.have.property('bookingid');
        expect(response.body.booking.totalprice).to.eq(0);
        examples.invalidBookings.invalidValues.zeroPrice.bookingId = response.body.bookingid;
      });
    });
  });
  ...
  context('RestfulBooker.Booking.Create.POST: When invalid date format is provided', () => {
    ...
    it('RestfulBooker.Booking.Create.POST: Then return 200 status code and invalid date format is accepted', () => {
      cy.restfullBooker__createBooking__POST(examples.invalidBookings.invalidValues.invalidDateFormat, { failOnStatusCode: false }).then((response) => {
        // Current actual behavior - API accepts invalid date format
        expect(response.status).to.eq(200);
        expect(response.body).to.have.property('bookingid');

        // Store booking ID for potential cleanup
        examples.invalidBookings.invalidValues.invalidDateFormat.bookingId = response.body.bookingid;
  ...
  context('RestfulBooker.Booking.Create.POST: When checkout date is before checkin date', () => {
    ...
    it('RestfulBooker.Booking.Create.POST: Then return 200 status code due to missing date logic validation', () => {
      const bookingData = examples.invalidBookings.invalidValues.checkoutBeforeCheckin;
      ...
      cy.restfullBooker__createBooking__POST(bookingData).then((response) => {
        ...
        examples.invalidBookings.invalidValues.checkoutBeforeCheckin.bookingId = response.body.bookingid;
        // Expected behavior after bug fix:
        // expect(response.status).to.eq(400);
        // expect(response.body).to.have.property('error');
  ...
  context('RestfulBooker.Booking.Create.POST: When empty string value is provided for required field', () => {
    ...
    it('RestfulBooker.Booking.Create.POST: Then return 200 status code and booking is created with empty field', () => {
      const { baseBooking, emptyStringFields } = examples.invalidBookings.emptyValues;
  ...
  context('RestfulBooker.Booking.Retrieve.GET: When all booking IDs are requested', () => {
    it('RestfulBooker.Booking.Retrieve.GET: Then return 200 status code and array of booking IDs', () => {
      cy.restfullBooker__getBookingIds__GET().then((response) => {
        ...
        expect(bookingIds).to.include(examples.validBookings.standard.bookingId);
      });
    });
  });
  ...
  context('RestfulBooker.Booking.Retrieve.GET: When booking IDs filtered by firstname are requested', () => {
    it('RestfulBooker.Booking.Retrieve.GET: Then return 200 status code and filtered results include created booking', () => {
      const searchParams = { firstname: examples.validBookings.standard.firstname };
  ...
  context('RestfulBooker.Booking.Retrieve.GET: When booking IDs filtered by lastname are requested', () => {
    it('RestfulBooker.Booking.Retrieve.GET: Then return 200 status code and filtered results include created booking', () => {
      const searchParams = { lastname: examples.validBookings.standard.lastname };
  ...
  context('RestfulBooker.Booking.Retrieve.GET: When booking IDs filtered by full name are requested', () => {
    it('RestfulBooker.Booking.Retrieve.GET: Then return 200 status code and filtered results include created booking', () => {
      const searchParams = {
        firstname: examples.validBookings.standard.firstname,
        lastname: examples.validBookings.standard.lastname,
      };
  ...
  context('RestfulBooker.Booking.Retrieve.GET: When booking IDs filtered by dates are requested', () => {
    ...
    it('RestfulBooker.Booking.Retrieve.GET: Then return 200 status code and array response', () => {
      const searchParams = examples.filters.byDateRange;
  ...
  context('RestfulBooker.Booking.Retrieve.GET: When booking IDs filtered by non-existing name are requested', () => {
    it('RestfulBooker.Booking.Retrieve.GET: Then return 200 status code and empty array', () => {
      const searchParams = examples.filters.nonExisting;
  ...
  context('RestfulBooker.Booking.Retrieve.GET: When existing booking ID is requested', () => {
    it('RestfulBooker.Booking.Retrieve.GET: Then return 200 status code and complete booking details', () => {
      cy.restfullBooker__getBookingById__GET(examples.validBookings.standard.bookingId).then((response) => {
        expect(response.status).to.eq(200);
        ...
        expect(response.body.firstname).to.eq(examples.validBookings.standard.firstname);
        expect(response.body.lastname).to.eq(examples.validBookings.standard.lastname);
        expect(response.body.totalprice).to.eq(examples.validBookings.standard.totalPrice);
        expect(response.body.depositpaid).to.eq(examples.validBookings.standard.depositPaid);
        expect(response.body.bookingdates.checkin).to.eq(examples.validBookings.standard.bookingDates.checkin);
        expect(response.body.bookingdates.checkout).to.eq(examples.validBookings.standard.bookingDates.checkout);
      });
    });
  });
  ...
  context('RestfulBooker.Booking.Retrieve.GET: When non-existing booking ID is requested', () => {
    it('RestfulBooker.Booking.Retrieve.GET: Then return 404 status code and Not Found message', () => {
      const nonExistingId = utils.getRandomElement(examples.ids.nonExisting);
  ...
  context('RestfulBooker.Booking.Retrieve.GET: When invalid booking ID is requested', () => {
    ...
    it('RestfulBooker.Booking.Retrieve.GET: Then return 404 status code for string ID', () => {
      const invalidId = examples.ids.invalid.string;
    ...
    it('RestfulBooker.Booking.Retrieve.GET: Then return 404 status code for negative ID', () => {
      const invalidId = examples.ids.invalid.negative;
    ...
    it('RestfulBooker.Booking.Retrieve.GET: Then return 404 status code for zero ID', () => {
      const invalidId = examples.ids.invalid.zero;
    ...
    it('RestfulBooker.Booking.Retrieve.GET: Then return 200 status code for float ID due to truncation', () => {
      const invalidId = examples.ids.invalid.float;
    ...
    it('RestfulBooker.Booking.Retrieve.GET: Then return 404 status code for special character ID', () => {
      const invalidId = examples.ids.invalid.special;
  ...
  context('RestfulBooker.Booking.Update.PUT: When valid full update is provided with authentication', () => {
    it('RestfulBooker.Booking.Update.PUT: Then return 200 status code and all fields are updated', () => {
      const updateData = examples.updates.full;

      cy.restfullBooker__updateBooking__PUT(authToken, examples.validBookings.standard.bookingId, updateData).then((response) => {
        expect(response.status).to.eq(200);
        ...
        examples.validBookings.standard = { ...examples.validBookings.standard, ...updateData };
      });
    });
  });
  ...
  context('RestfulBooker.Booking.Update.PUT: When update is attempted without authentication', () => {
    it('RestfulBooker.Booking.Update.PUT: Then return 403 status code and Forbidden message', () => {
      ...
      cy.restfullBooker__updateBooking__PUT('invalid_token', examples.validBookings.withoutAdditionalNeeds.bookingId, updateData, { failOnStatusCode: false }).then((response) => {
  ...
  context('RestfulBooker.Booking.PartialUpdate.PATCH: When single field is partially updated', () => {
    it('RestfulBooker.Booking.PartialUpdate.PATCH: Then only specified field changes and others remain unchanged', () => {
      const singleFieldUpdates = examples.updates.partial.singleFieldUpdates;
      const [fieldName, newValue] = utils.getRandomEntry(singleFieldUpdates);

      // Handle depositPaid toggle
      let updateData;
      if (fieldName === 'depositPaid') {
        updateData = { [fieldName]: !examples.validBookings.edgeCases.minimalPrice[fieldName] };
      } else {
      ...
      cy.restfullBooker__partialUpdateBooking__PATCH(authToken, examples.validBookings.edgeCases.minimalPrice.bookingId, updateData).then((response) => {
        expect(response.status).to.eq(200);
        ...
        examples.validBookings.edgeCases.minimalPrice[fieldName] = updateData[fieldName];
      });
    });
  });
  ...
  context('RestfulBooker.Booking.PartialUpdate.PATCH: When only checkin date is updated', () => {
    ...
    it('RestfulBooker.Booking.PartialUpdate.PATCH: Then checkin changes and checkout is preserved using workaround', () => {
      const updateData = examples.updates.partial.updateCheckinOnly;

      // First, get current booking state to capture original checkout date
      cy.restfullBooker__getBookingById__GET(examples.validBookings.edgeCases.maximalPrice.bookingId).then((getResponse) => {
        ...
        cy.restfullBooker__partialUpdateBooking__PATCH(authToken, examples.validBookings.edgeCases.maximalPrice.bookingId, completeUpdateData).then((response) => {
          expect(response.status).to.eq(200);
          expect(response.body.bookingdates.checkin).to.eq(updateData.bookingDates.checkin);
          expect(response.body.bookingdates.checkout).to.eq(originalCheckout);

          // Update stored booking
          examples.validBookings.edgeCases.maximalPrice.bookingDates.checkin = updateData.bookingDates.checkin;
          examples.validBookings.edgeCases.maximalPrice.bookingDates.checkout = originalCheckout;
  ...
  context('RestfulBooker.Booking.PartialUpdate.PATCH: When only checkout date is updated', () => {
    ...
    it('RestfulBooker.Booking.PartialUpdate.PATCH: Then checkout changes and checkin is preserved using workaround', () => {
      const updateData = examples.updates.partial.updateCheckoutOnly;
      ...
      cy.restfullBooker__getBookingById__GET(examples.validBookings.edgeCases.maximalPrice.bookingId).then((getResponse) => {
        ...
        cy.restfullBooker__partialUpdateBooking__PATCH(authToken, examples.validBookings.edgeCases.maximalPrice.bookingId, completeUpdateData).then((response) => {
          ...
          // Update stored booking
          examples.validBookings.edgeCases.maximalPrice.bookingDates.checkout = updateData.bookingDates.checkout;
          examples.validBookings.edgeCases.maximalPrice.bookingDates.checkin = originalCheckin;
  ...
  context('RestfulBooker.Booking.PartialUpdate.PATCH: When multiple fields are partially updated', () => {
    it('RestfulBooker.Booking.PartialUpdate.PATCH: Then all specified fields change and others remain unchanged', () => {
      const updateData = examples.updates.partial.multipleFields;

      cy.restfullBooker__partialUpdateBooking__PATCH(authToken, examples.validBookings.edgeCases.longStay.bookingId, updateData).then((response) => {
        expect(response.status).to.eq(200);
        expect(response.body.firstname).to.eq(updateData.firstname);
        expect(response.body.totalprice).to.eq(updateData.totalPrice);
        expect(response.body.depositpaid).to.eq(updateData.depositPaid);
        ...
        expect(response.body.lastname).to.eq(examples.validBookings.edgeCases.longStay.lastname);
      });
    });
  });
  ...
  context('RestfulBooker.Booking.PartialUpdate.PATCH: When partial update is attempted without authentication', () => {
    it('RestfulBooker.Booking.PartialUpdate.PATCH: Then return 403 status code and Forbidden message', () => {
      ...
      cy.restfullBooker__partialUpdateBooking__PATCH('invalid_token', examples.validBookings.edgeCases.depositNotPaid.bookingId, updateData, { failOnStatusCode: false }).then((response) => {
        expect(response.status).to.eq(403);
        expect(response.body).to.eq(errors.common.forbidden);
      });
    });
  ...
  context('RestfulBooker.Booking.Delete.DELETE: When valid booking ID is deleted with authentication', () => {
    ...
    it('RestfulBooker.Booking.Delete.DELETE: Then return 201 status code and booking is deleted', () => {
      cy.restfullBooker__deleteBooking__DELETE(authToken, examples.validBookings.edgeCases.sameDayCheckout.bookingId).then((response) => {
        expect(response.status).to.eq(201);
      });

      // Verify deletion
      cy.restfullBooker__getBookingById__GET(examples.validBookings.edgeCases.sameDayCheckout.bookingId, { failOnStatusCode: false }).then((response) => {
        expect(response.status).to.eq(404);
        expect(response.body).to.eq(errors.common.notFound);
      });
    });
  ...
  context('RestfulBooker.Booking.Delete.DELETE: When delete is attempted without authentication', () => {
    it('RestfulBooker.Booking.Delete.DELETE: Then return 403 status code and Forbidden message', () => {
      cy.restfullBooker__deleteBooking__DELETE('invalid_token', examples.validBookings.standard.bookingId, { failOnStatusCode: false }).then((response) => {
        expect(response.status).to.eq(403);
        expect(response.body).to.eq(errors.common.forbidden);
      });
    });
  ...
  context('RestfulBooker.Booking.Delete.DELETE: When cleaning up test data', () => {
    ...
    it('RestfulBooker.Booking.Delete.DELETE: Then all remaining test bookings are deleted successfully', () => {
      ...
      ['standard', 'withoutAdditionalNeeds'].forEach((key) => {
        if (examples.validBookings[key]?.bookingId) {
          bookingsToDelete.push(examples.validBookings[key].bookingId);
        }
      });
      ...
      ['minimalPrice', 'maximalPrice', 'longStay', 'depositNotPaid'].forEach((key) => {
        if (examples.validBookings.edgeCases[key]?.bookingId) {
          bookingsToDelete.push(examples.validBookings.edgeCases[key].bookingId);
        }
      });
