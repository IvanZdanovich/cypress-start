---
applyTo: "${WORKSPACE_ROOT}/cypress/integration-requirements/ui/*.ui.spec.js"
---
...
STORE test data: `${WORKSPACE_ROOT}/cypress/test-data/ui/page-name.component-name.ui.examples.js` (kebab-case)
...
STORE: `${WORKSPACE_ROOT}/cypress/test-data/ui/page-name.component-name.ui.examples.js`
