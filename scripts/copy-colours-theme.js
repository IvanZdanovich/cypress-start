...
const sourcePath = path.join(__dirname, `../cypress/support/colours/${colourThemeCode}-theme-colours.json`);
const destinationPath = path.join(__dirname, '../cypress/support/colours/current-theme-colours.json');
