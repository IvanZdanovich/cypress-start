...
const sourcePath = path.join(__dirname, `../cypress/support/localization/${languageCode}-localization.json`);
const destinationPath = path.join(__dirname, '../cypress/support/localization/l10n.json');
